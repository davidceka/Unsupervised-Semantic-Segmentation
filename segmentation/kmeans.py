...
def main():
    ...
    val_dataset = iMaterialist(split='val', transform=val_transforms)
    val_dataloader = get_val_dataloader(p, val_dataset)

    true_val_dataset = iMaterialist(split='val', transform=None)
    ...
    for i in range(args.num_seeds):
        ...
        eval_stats = eval_kmeans(p, true_val_dataset, n_clusters=n_clusters, verbose=False)
