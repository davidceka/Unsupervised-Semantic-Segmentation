...
def main():
    ...
    train_dataset = iMaterialist(split='train', transform=val_transforms, ignore_classes=p['retrieval_kwargs']['ignore_classes'])
    val_dataset = iMaterialist(split='val', transform=val_transforms, ignore_classes=p['retrieval_kwargs']['ignore_classes'])
